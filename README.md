# Easybotics RPi air-quality station Configuration Script

Configuration script to help setup some useful options on a new Raspberry Pi, especially with the [easybotics air-quality station](https://www.npmjs.com/package/node-red-contrib-easybotics-air-quality).  The script customizes a Raspbian image by making the follow changes: 
* google chrome config with default bookmarks
* sets the desktop wallpaper
* installs node-red nodes required by the easybotics air-quality station

Script is a work in progress.  

## `easybotics-air-quality-config-script`
